<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="EditEmployeeProfile.aspx.cs" Inherits="Lab2.EditEmployeeProfile" %>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-8">
                    ...
                    <%--<button type="reset" class="btn btn-default" onclick="cancelButtonClick">Cancel</button>--%>
                        ...
                        <asp:Button ID="cancelButton" runat="server" Text="Cancel" OnClick="cancelButton_Click" class="btn btn-default"/>
                  </div>
                </div>
                  </div>
                </div>
