...
namespace Lab2
{
    public partial class StatusEditPage : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            dtasrcServiceList.SelectParameters.Add("customerID", Session["customerID"].ToString());
            dtasrcServiceList.SelectCommand = "Select ServiceTicketID from serviceTicket WHERE(CustomerID = @customerID)";
        ...
        protected void updateGridView()
        {
            ...
            String sqlMain = "SELECT * FROM ServiceTicket WHERE CustomerID =" + Session["customerID"].ToString();
