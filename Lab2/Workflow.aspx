...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <%--<fieldset>
        <legend>Select Customer to view the Service Ticket</legend>
        <asp:DropDownList ID="ddlCustomerList" runat="server"
            ...
            AutoPostBack="true" OnSelectedIndexChanged="customerSelected">
        </asp:DropDownList>
        <br />
    ...
    <fieldset>
        <legend>Select the Customer and Service Ticket to add a Note to</legend>
        ...
        <asp:TableRow>
            ...
            <asp:TableCell>
                <asp:DropDownList ID="employeeList" runat="server"
                    DataSourceID="dtasrcEmployeeList" DataTextField="EmployeeName" DataValueField="EmployeeID" AutoPostBack="true">
                </asp:DropDownList>
            </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
