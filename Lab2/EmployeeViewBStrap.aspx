<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="EmployeeViewBStrap.aspx.cs" Inherits="Lab2.EmployeeViewBStrap" %>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger text-black" href="#page-top">Employees</a>
                    </li>
                </ul>
            </div>
        </div>
